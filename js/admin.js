...
$("#controls-play").click(function() {
    socket.emit('controls-play', null);
});
$("#controls-pause").click(function() {
    socket.emit('controls-pause', null);
});
$("#controls-next").click(function() {
    socket.emit('controls-next', null);
});
$("#controls-prev").click(function() {
    socket.emit('controls-prev', null);
});
$("#controls-volume").on("input", function() {
    console.log("Changing volume to " + $(this).val());
    socket.emit("controls-volume", $(this).val());
});
